...
/home/programs/DAS_Tool/DAS_Tool -i htn_maxbin.contigs2bin.tsv,htn_metabat.scaffolds2bin.tsv,htn_concoct.scaffolds2bin.tsv -l maxbin,metabat,concoct -c data/htn.fasta -o results/htn_bins --debug --t 4 --write_bins --search_engine diamond
```
...
checkm  lineage_wf -t 4 -x fa DAStools-log_htn CheckM_DAS_Tool -f CheckM-DAS_Tool_bins.txt
```
