...
concoct --coverage_file concoct_coverage_table_htn.tsv --composition_file htn.fasta-split10K.fa --clusters 400 --kmer_length 4 --threads 1 --length_threshold 3000 --basename concot --seed 4 --iterations 500
```
