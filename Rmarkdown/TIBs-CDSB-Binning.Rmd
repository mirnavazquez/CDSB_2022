...
```{bash eval=F}
mkdir -p 07.MaxBin/{data,results,logs}
cd 07.MaxBin/
...
```
**131 bins, 58.37 min, puede mejorar si se bajan las iteraciones (deafult 50) y se indican los nodos (default 1)** OKAY BAJEMOS LAS ITERACIONES A 1. --- YO NO SE POR QUE NO PUEDO INSTALAR ESTE AMBIENTE
