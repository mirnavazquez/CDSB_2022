...
Primero me puedes decir cuantas lineas tiene tu archivo?
...
Okay... quiza podamos recuperar algunos mas.
...
#load a bin
mm <- mmload(
  assembly = "/home/mirna/05.DAS_tool/results/htn_bins_DASTool_bins/maxbin.024_sub.fa",
  coverage = "/home/mirna/03.Metabat/data/",
  verbose = TRUE,
  kmer_pca = FALSE,
  kmer_BH_tSNE = FALSE
)
#plot all combinations of coverage depths
mmplot_pairs(mm,
             variables = c("cov_4991_11_H1",
                           "cov_4993_5_H1",
                           "cov_4993_5_H3",
                           "cov_4993_5_H4",
                           "cov_4993_5_LG"),
             ...
             size_scale = 0.4,
             textsize = 2)
#See the stats for the data frame
mmstats(mm)
#mmplot one combo from above that has clear outliers
mmplot(mm,
       x = "cov_4991_11_H1",
       y = "cov_4993_5_H1",
       min_length = 2500,
...
#select data
shiny_selection = data.frame(cov_4991_11_H1 = c(1.163, 1.178, 0.333, 1.147, 3.412, 2.537),
                             cov_4993_5_H1 = c(42.885, 43.418, 30.819, 22.036, 29.627, 38.29))#subset data and export cleaned bin
mmsubset <- mmextract(mm, selection = shiny_selection)
#Copy this information into the excel file on the drive
mmexport(mmsubset, assembly = assembly, file = "D4993_C5_H1_Bin_396_clean.fna")
...
Aja! falta el bin de maxbin, okay ... ese vamos a intentar limpiarlo.
